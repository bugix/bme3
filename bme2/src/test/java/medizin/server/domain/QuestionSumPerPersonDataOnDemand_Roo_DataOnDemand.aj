...
privileged aspect QuestionSumPerPersonDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    AssesmentDataOnDemand QuestionSumPerPersonDataOnDemand.assesmentDataOnDemand;
    
    @Autowired
    QuestionEventDataOnDemand QuestionSumPerPersonDataOnDemand.questionEventDataOnDemand;
    
    @Autowired
    PersonDataOnDemand QuestionSumPerPersonDataOnDemand.personDataOnDemand;
