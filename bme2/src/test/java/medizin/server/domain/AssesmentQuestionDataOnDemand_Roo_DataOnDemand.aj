...
privileged aspect AssesmentQuestionDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    AssesmentDataOnDemand AssesmentQuestionDataOnDemand.assesmentDataOnDemand;
    
    @Autowired
    PersonDataOnDemand AssesmentQuestionDataOnDemand.personDataOnDemand;
    
    @Autowired
    QuestionDataOnDemand AssesmentQuestionDataOnDemand.questionDataOnDemand;
