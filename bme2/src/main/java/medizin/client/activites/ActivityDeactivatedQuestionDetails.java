...
public class ActivityDeactivatedQuestionDetails extends AbstractActivityWrapper implements 
		...
		requests.find(placeDeactivatedQuestionDetails.getProxyId()).with("previousVersion","keywords","questEvent","questionType","mcs", "rewiewer", "autor","questionResources","answers").fire(new BMEReceiver<Object>() {
			...
			public void onSuccess(final Object response) {
				if(response instanceof QuestionProxy){
					...
					QuestionDetailsViewImpl questionDetailsView = new QuestionDetailsViewImpl(eventBus, false,false,false,false,false,isQuestionTypeMCQ((QuestionProxy) response), false);
	...
	private void initKeywordView() {
		...
		//Added this to get keywords by name ASC - Manish.
	...
	{
		//Added this to show all main classification in ASC order by its description - Manish.
	...
	{
		//Added this to show all appliances by its shortcut as ASC.
