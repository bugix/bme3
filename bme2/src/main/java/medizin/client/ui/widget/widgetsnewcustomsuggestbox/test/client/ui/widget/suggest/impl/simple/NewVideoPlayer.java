...
public class NewVideoPlayer extends Composite {
  ...
  public NewVideoPlayer(String title, int height, int width, String videoUrl){
    thisHeight = height;
    thisWidth = width;
  ...
  private String createHtmlEmbedded(String title, int height, int width, String videoUrl){
    StringBuffer buffer = new StringBuffer();
    buffer.append("<object type=\"application/x-shockwave-flash\" ");
    buffer.append("data=\""+GWT.getModuleBaseURL()+"flash/player_flv.swf\" height=\""+height+"\" width=\"" + width +"\">");
    buffer.append("\n<param name=\"movie\" value=\""+GWT.getModuleBaseURL()+"flash/player_flv.swf\">");
    buffer.append("<param name=\"wmode\" value=\"transparent\">");
    buffer.append("<param name=\"allowFullScreen\" value=\"true\">");
    buffer.append("<param name=\"FlashVars\" value=\"title="+title+"&amp;" +
        ...
        "sliderovercolor=0066cc&amp;flv=" + videoUrl + "&amp;thisWidth="+width+"&amp;thisHeight="+height+"\">");        
