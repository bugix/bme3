...
import medizin.client.ui.widget.widgetsnewcustomsuggestbox.test.client.ui.widget.AdvancedTextBox;
...
public class SuggestTextBoxWidgetImpl<T, W extends EventHandlingValueHolderItem<T>>
	...
	public SuggestTextBoxWidgetImpl() {
		 ...
		 * Auto-generated method stub Log.info("arrow click");
		 * 
		 * } });
		 */
	...
	/*
	 * @Override public String getDefaultText() { return
	 * advancedTextBox.getDefaultText(); }
	 */
	...
	/*
	 * @Override public Validator<String> getValidator() { return
	 * advancedTextBox.getValidator(); }
	 * 
	 * @Override public void setValidator(Validator<String> validator) {
	...
	/*
	 * public HandlerRegistration addClickHandler(ClickHandler handler) { return
	 * arrowButton.addClickHandler(handler); }
	 */
	...
	public void onMouseDown(MouseDownEvent event) {
		 ...
		 * representer.hideSuggestList(false);
		 * 
		 * } else { //representer.recomputePopupContent(KeyCodes.KEY_DOWN);
		 * representer.recomputeAllPopupContent(KeyCodes.KEY_DOWN,null);
		 * representer.highlightSelectedValue();
		 * 
		 * }
	...
	/*
	 * @UiHandler("arrowButton") public void onClick(ClickEvent event) {
	...
	public void onMouseMove(MouseMoveEvent event) {
		...
		representer.mouseOnButton(mousePosition > (advancedTextBox
				.getOffsetWidth() - buttonWidth));
	}
	...
	/*
	 * @Override public void setValidator(Validator<String> validator) { // TODO
	 ...
	 * 
	 * 
	 * @Override public Validator<String> getValidator() { // TODO
