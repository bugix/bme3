...
public class EventAccessViewImpl extends Composite implements EventAccessView {

	private static EventAccessViewImplUiBinder uiBinder = GWT
			.create(EventAccessViewImplUiBinder.class);

	interface EventAccessViewImplUiBinder extends
			UiBinder<Widget, EventAccessViewImpl> {
	}
