...
public class QuestionUsedInMC extends Composite implements RecordChangeHandler {

	private static QuestionUsedInMCUiBinder uiBinder = GWT.create(QuestionUsedInMCUiBinder.class);

	interface QuestionUsedInMCUiBinder extends UiBinder<Widget, QuestionUsedInMC> {
	}
