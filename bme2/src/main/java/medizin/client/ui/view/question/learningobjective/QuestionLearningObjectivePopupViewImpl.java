...
public class QuestionLearningObjectivePopupViewImpl extends PopupPanel implements QuestionLearningObjectivePopupView {

private static final Binder BINDER = GWT.create(Binder.class);
	
	interface Binder extends UiBinder<Widget, QuestionLearningObjectivePopupViewImpl> {
	}
	...
	public QuestionLearningObjectivePopupViewImpl() {
		super(true);
