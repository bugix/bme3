...
import medizin.client.ui.view.assesment.AssesmentView.Presenter;
...
//	        table.addColumn(new TextColumn<QuestionProxy>() {
//
//	            Renderer<java.util.Set> renderer = medizin.client.ui.view.roo.CollectionRenderer.of(medizin.client.ui.view.roo.KeywordProxyRenderer.instance());
//
//	            @Override
//	            public String getValue(QuestionProxy object) {
...
//	        table.addColumn(new TextColumn<QuestionProxy>() {
//
//	            Renderer<medizin.client.managed.request.QuestionEventProxy> renderer = medizin.client.ui.view.roo.QuestionEventProxyRenderer.instance();
//
//	            @Override
//	            public String getValue(QuestionProxy object) {
...
//	        table.addColumn(new TextColumn<QuestionProxy>() {
//
//	            Renderer<medizin.client.managed.request.CommentProxy> renderer = medizin.client.ui.view.roo.CommentProxyRenderer.instance();
//
//	            @Override
//	            public String getValue(QuestionProxy object) {
...
//	        table.addColumn(new TextColumn<QuestionProxy>() {
//
//	            Renderer<medizin.client.managed.request.QuestionTypeProxy> renderer = medizin.client.ui.view.roo.QuestionTypeProxyRenderer.instance();
//
//	            @Override
//	            public String getValue(QuestionProxy object) {
...
//	        table.addColumn(new TextColumn<QuestionProxy>() {
//
//	            Renderer<java.util.Set> renderer = medizin.client.ui.view.roo.CollectionRenderer.of(medizin.client.ui.view.roo.McProxyRenderer.instance());
//
//	            @Override
//	            public String getValue(QuestionProxy object) {
...
//	        table.addColumn(new TextColumn<QuestionProxy>() {
//
//	            Renderer<java.util.Set> renderer = medizin.client.ui.view.roo.CollectionRenderer.of(medizin.client.ui.view.roo.AnswerProxyRenderer.instance());
//
//	            @Override
//	            public String getValue(QuestionProxy object) {
