...
public class McGinModule extends AbstractGinModule {
	...
	static class RequestFactoryProvider implements Provider<McAppRequestFactory> {
		...
		public RequestFactoryProvider(EventBus eventBus) {
			...
			requestFactory.initialize(eventBus, new medizin.client.factory.request.EventSourceRequestTransport(eventBus));
		}
